...
const description = `I am a bot to help you avoid merge conflicts in (Game) Dev Teams :innocent:
        ...
        You can call me in already existing channel for your project. If you're working on multiple projects, you can call me in multiple channels without polluting the lock status of other projects! *p.s. I also keep the channel tidy!*
