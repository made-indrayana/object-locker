...
module.exports = {
    name: 'about',
    args: false,
    description: 'Simulate join server message',
    async execute(message) {
        const description = `I am a bot trying to help avoid merge conflicts in (Game) Dev Teams :innocent:
        
        If you're using \`git\` as your version control and want to work on non-mergeable object, like Unity Scenes or Prefabs,
        you can definitely use me to tell all of the team members that you're working on them!
        ...
        Try using \`!lock yourSceneName\` to announce "I'M WORKING ON THIS :nerd:
        When you're finished, use \`!unlock yourSceneName\` to say "I'M DONE WITH THIS :sunglasses:
        
        Whenever you want to know who is working on what on a project, use \`!lockstatus\`.
        ...
        message.channel.send(embed('Hi! I\'m Object Locker :yum:', `${description}`));
    },
};
